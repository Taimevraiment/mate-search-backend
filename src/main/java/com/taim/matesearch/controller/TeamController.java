...
import com.taim.matesearch.common.DeleteRequest;
...
import com.taim.matesearch.model.request.TeamAddRequest;
...
@RestController
@RequestMapping("/team")
@CrossOrigin(origins = {"http://localhost:3000","http://matesearch.taim.site"})
@Slf4j
public class TeamController {
    ...
    public BaseResponse<List<TeamUserVO>> listTeams(TeamQuery teamQuery, HttpServletRequest request) {
        ...
        // 1、查询队伍列表
        teamQuery.setCurrUserId(userService.getLoginUser(request).getId());
